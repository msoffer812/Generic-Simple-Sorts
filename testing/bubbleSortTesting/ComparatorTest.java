...
class ComparatorTest {
	...
	@Test
	void bubbleSortOfCarsSortsWithCustomComparatorByNameCorrectly() {
		sortedCars = new Car[] {c1, c2, c3, c4, c5, c6, c7};
		comparator = new CarNameComparator();
		BubbleSort<Car> sort = new BubbleSort<Car>(comparator);
		sort.sort(cars);
		assertArrayEquals(cars, sortedCars);
	}
	
	@Test
	void bubbleSortOfCarsSortsWithCustomComparatorByYearCorrectly() {
	...
	@Test
	void bubbleSortOfCarsSortsWithCustomComparatorByCostCorrectly() {
