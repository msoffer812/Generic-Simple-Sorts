...
class ComparableTest {
	...
	@Test
	void selectionSortOfCarsSortsByDefaultOrderCorrectly() {
		SelectionSort<Car> sort = new SelectionSort<Car>();
		sort.sort(cars);
		assertArrayEquals(cars, sortedCars);
	}
	
	@Test
	void selectionSortOfStringsSortsByDefaultOrderCorrectly() {
	...
	@Test
	void selectionSortOfIntsSortsByDefaultOrderCorrectly() {
